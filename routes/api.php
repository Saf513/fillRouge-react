...
Route::middleware(['role:teacher'])->prefix('teacher')->group(function () {
    ...
    // Routes pour les ressources de cours
    Route::post('/courses/{course}/resources', [CourseResourceController::class, 'store']);
    Route::put('/courses/{course}/resources/{resource}', [CourseResourceController::class, 'update']);
...
// Route publique pour télécharger une ressource de cours
Route::get('/courses/{course}/resources/{resource}/download', [CourseResourceController::class, 'download']);
